const CACHE_NAME = 'excelkospi-static-20260526-521';
const API_CACHE_NAME = 'excelkospi-api-20260526-521';
...
const APP_SHELL = [
  '/',
  '/index.html',
  '/manifest.webmanifest?v=20260521-408',
  '/favicon.ico?v=20260521-408',
  '/assets/app.css?v=20260525-518',
  '/assets/app-config.js?v=20260526-521',
  '/assets/app-utils.js?v=20260526-521',
  '/assets/app-mentions.js?v=20260524-471',
  '/assets/app-community-read.js?v=20260525-499',
  '/assets/community-ui.js?v=20260526-521',
  '/assets/app-personal-feed.js?v=20260525-492',
  '/assets/app-outlook.js?v=20260525-518',
  '/assets/app-outlook-preview.js?v=20260525-494',
  '/assets/app-watchlist-share.js?v=20260525-495',
  '/assets/app-cell-selection.js?v=20260525-510',
  '/assets/app-quote-table.js?v=20260525-505',
  '/assets/app-quote-drag.js?v=20260525-496',
  '/assets/app-quote-controls.js?v=20260525-506',
  '/assets/app-mini-chart.js?v=20260525-511',
  '/assets/app-tradingview.js?v=20260525-510',
  '/assets/app-chat-ui.js?v=20260525-506',
  '/assets/app.js?v=20260526-521',
  '/assets/favicon.svg?v=20260521-408',
  '/assets/favicon-32.png?v=20260521-408',
  '/assets/icon-192.png?v=20260521-408',
];
