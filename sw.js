const CACHE_NAME = 'excelkospi-static-20260526-524';
const API_CACHE_NAME = 'excelkospi-api-20260526-524';
...
const APP_SHELL = [
  ...
  '/assets/app.css?v=20260526-523',
  '/assets/app-config.js?v=20260526-524',
