...
const CHAT_CLOSED_POLL_MS = 2 * 60 * 1000;
const CHAT_OPEN_POLL_MS = 7500;
const CHAT_SEND_GAP_MS = 4 * 1000;
const CHAT_BUSY_POLL_ONLINE_THRESHOLD = 350;
const CHAT_BUSY_OPEN_POLL_MS = 10 * 1000;
const CHAT_PRESENCE_POLL_MS = 60 * 1000;
const CHAT_PRESENCE_BUSY_POLL_MS = 75 * 1000;
const CHAT_PRESENCE_PEAK_POLL_MS = 90 * 1000;
...
const FAST_QUOTE_EXTENDED_MS = 30 * 1000;
...
const PATCH_NOTES_URL = '/patch-notes.md?v=20260524-469';
